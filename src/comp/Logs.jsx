                    ...
                    <div class="max-w-screen-xl flex flex-wrap items-center justify-between">
                        ...
                        <div class="hidden md:block" id="navbar-dropdown">
                            <ul class="flex flex-col font-semibold font-sans md:p-3  border-white-100  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-white-100 md:dark:bg-white-100 dark:border-green-700">
                                <li>
                                    <button onClick={dash} class="block py-2 px-3 text-green-100 rounded hover:bg-lime-200 md:hover:bg-transparent md:border-0 md:hover:text-black-100 md:p-0 dark:text-white md:dark:hover:text-green-500 dark:hover:bg-green-700 dark:hover:text-white md:dark:hover:bg-transparent">Home</button>
                                </li>
                                <li>
                                    <button onClick={add} class="block py-2 px-3 text-green-100 rounded hover:bg-lime-200 md:hover:bg-transparent md:border-0 md:hover:text-black-100 md:p-0 dark:text-white md:dark:hover:text-green-500 dark:hover:bg-green-700 dark:hover:text-white md:dark:hover:bg-transparent">Add</button>
                                </li>
                                <li>
                                ...
                                <li>
                                    <ul class="block py-2 px-3 text-green-100 rounded hover:bg-lime-200 md:hover:bg-transparent md:border-0 md:hover:text-black-100 md:p-0 dark:text-black md:dark:hover:text-green-500 dark:hover:bg-green-700 dark:hover:text-white md:dark:hover:bg-transparent">
                                        <button onClick={() => setIsOpen(!isOpen)} type="button" class="block py-2 px-3 text-green-100 rounded hover:bg-lime-200 md:hover:bg-transparent md:border-0 md:hover:text-black-100 md:p-0 dark:text-white md:dark:hover:text-green-500 dark:hover:bg-green-700 dark:hover:text-white md:dark:hover:bg-transparent" id="menu-button" aria-expanded="true" aria-haspopup="true">
                                            Username
                                        </button>
                                    </ul>
                                </li>
                ...
                <div class="relative mx-20 my-14 overflow-x-auto shadow-black-200 shadow-xl sm:rounded-lg">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase dark:text-gray-400">
                            <tr>
                                <th scope="col" class="px-6 py-3 bg-gray-50 dark:bg-lime-200">
                                    URL Status
                                </th>
                        ...
                        <tbody>
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-black dark:bg-lime-200">
                                    http://example.com
                                </th>
                                <td class="px-6 py-4">
                                    2020-08-08 06:46:07
                                </td>
                                <td class="px-6 py-4 bg-gray-50 dark:bg-lime-200">
                                    2020-08-08 06:49:06
                                </td>
                                <td class="px-6 py-4">
                                    2min, 59s
                            ...
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                ...
                                </td>     <td class="px-6 py-4 bg-gray-50 dark:bg-lime-200">
